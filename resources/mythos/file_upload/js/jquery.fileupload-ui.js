...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        options: {
            ...
            start: function (e) {
                var that = $(this).data('fileupload');
				$('.fileupload-buttonbar .progress').removeClass('hide');
            ...
            stop: function (e) {
                ...
                that._transition($(this).find('.fileupload-buttonbar .progress')).done(
                    function () {
						$('.fileupload-buttonbar .progress').addClass('hide');
        ...
        _initButtonBarEventHandlers: function () {
            ...
            fileUploadButtonBar.find('.delete')
                .bind('click.' + ns, function (e) {
					e.preventDefault();
                    filesList.find('.checkdel input:checked').each(function() {
						$(this).parent().parent().find('.delete a').click();
					});
            ...
            fileUploadButtonBar.find('.toggle')
                .bind('change.' + ns, function (e) {
                    filesList.find('.checkdel input').prop(
                        'checked',
                        $(this).is(':checked')
                    );
                });
