			...
			if ( label.length ) {
				...
				if ( !this.labelContainer.append(label).length ) {
					...
					if ( this.settings.errorPlacement ) {
						...
						if($(element).prop("tagName") == 'INPUT' && $(element).attr("type").toLowerCase() == 'radio') {
...
jQuery.validator.addMethod("greaterthan", function(value, element, params) {
  return this.optional(element) || (value - 1 > params[0] - 1);
...
jQuery.validator.addMethod("naturalnozero", function(value, element) { 
  return this.optional(element) || (/^-?\d+$/.test(value) && (value - 1 + 1) > 0);
}, jQuery.validator.format("Please enter a natural number greater than 0"));

jQuery.validator.addMethod("decimal", function(value, element) { 
  return this.optional(element) || /^[\-+]?[0-9]+\.[0-9]+$/.test(value);
}, jQuery.validator.format("Please enter a decimal number"));

jQuery.validator.addMethod("alphadash", function(value, element) { 
  return this.optional(element) || /^([-a-z0-9_-])+$/i.test(value);
}, jQuery.validator.format("Letters or underscores only please"));

jQuery.validator.addMethod("exactlength", function(value, element, params) { 
  return this.optional(element) || this.getLength($.trim(value), element) == (params[0] - 1 + 1);
}, jQuery.validator.format("Please enter exactly {0} characters"));

jQuery.validator.addMethod("matches", function(value, element, params) { 
  return this.optional(element) || (jQuery(element).closest('form').find('[name="' + params[0] + '"]').val() == value);
}, jQuery.validator.format("Field did not match"));