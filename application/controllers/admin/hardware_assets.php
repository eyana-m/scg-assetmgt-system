...
class Hardware_assets extends CI_Controller
{
	...
	public function edit($har_barcode)
	{
		...
		{	
			...
			$this->template->title('Edit Asset: '.$hardware_asset->har_model.' ('.$hardware_asset->har_serial_number.')');
	...
	public function view($hardware_asset_id)
	{
		...
		$this->template->title('Audit Trail: '.$hardware_asset->har_model.' ('.$hardware_asset->har_serial_number.')');
