...
<div class="col-md-2" style="margin-bottom: 10px; margin-top: 5px; margin-right: 0" >
	<form  method="post" action="<?php echo site_url("admin/hardware_assets/filter_csv"); ?>" class="pull-right" name="filter_csv" id="filter_csv">
		...
		<input class="btn btn-primary btn-small no-border-radius" name="submit" type="submit" style="font-size: 1em" value="Generate CSV">
	</form>
</div>
