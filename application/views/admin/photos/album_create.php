...
<form method="post">
	<table class="table-form table-bordered">
		<tr>
			<th>Album Name</th>
			<td><input type="text" name="alb_name" class="span6" /></td>
		</tr>
		<tr>
			<th>Description</th>
			<td><textarea name="alb_description" class="span6" rows="5"></textarea></td>
		</tr>
		<tr>
			<th></th>
			<td>
				...
				<a href="<?php echo site_url('admin/photos'); ?>" class="btn">Back</a>
			</td>
		</tr>
	</table>
</form>
