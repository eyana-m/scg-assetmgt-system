...
--
-- Host: localhost
-- Generation Time: Nov 23, 2014 at 11:55 PM
...
CREATE TABLE IF NOT EXISTS `audit_entry` (
  ...
  `aud_datetime` datetime NOT NULL,
  `aud_status` varchar(30) NOT NULL,
  `aud_comment` text NOT NULL,
  `aud_har` int(11) NOT NULL,
  `aud_per` int(11) NOT NULL,
  PRIMARY KEY (`aud_id`),
  KEY `har_id` (`aud_har`),
  KEY `har_id_2` (`aud_har`),
  KEY `rem_per` (`aud_per`),
  KEY `rem_per_2` (`aud_per`),
  KEY `rem_per_3` (`aud_per`),
  KEY `rem_har` (`aud_har`),
  KEY `rem_har_2` (`aud_har`),
  KEY `aud_har` (`aud_har`),
  KEY `aud_har_2` (`aud_har`)
...
ALTER TABLE `audit_entry`
  ADD CONSTRAINT `audit_entry_ibfk_2` FOREIGN KEY (`aud_per`) REFERENCES `personnel` (`per_id`),
  ADD CONSTRAINT `audit_entry_ibfk_1` FOREIGN KEY (`aud_har`) REFERENCES `hardware` (`har_id`);
